...
def tableExists(dbHost, Port, serviceName, userName, password, tableName):
    conn = None
    cursor = None
    try:
        dao = OracleDAO(
...
def getTableColumns(dbHost, Port, serviceName, userName, password, tableName):
    conn = None
    cursor = None
    try:
        dao = OracleDAO(
...
def validateColumns(dbHost, Port, serviceName, userName, password, tableName, selectColumns):
    try:
        tableColumns = getTableColumns(dbHost, Port, serviceName, userName, password, tableName)
        missing = None
